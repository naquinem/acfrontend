	...
	return (
		<>
			<div className='h-full'>
				<nav className=" border-gray-200 sm:px-4 py-2.5 dark:bg-gray-900">
					<div className="bg-gray-200 container flex flex-wrap items-center justify-between mx-auto">
				...
				<main className="container height:90vh my-20">
					<Outlet />
				</main>
				<footer className='container py-2 grid justify-center bg-gray-400'>
					<p>Call now!</p>
					<h3 className='text-4xl text-bold font-bold mb-5'>+639165639733</h3>
					<h5 className='text-gray-500 mb-5'>
						Copyright © 2023 aircontractor | Powered by aircontractor
					</h5>
				</footer>
			</div>
		</>
